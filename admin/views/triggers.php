...
<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" class="myp-form">
	...
	<div class="myp-card myp-card--feature">
		<label class="myp-master">
			...
			<span class="myp-master__copy">
				<strong><?php esc_html_e( 'Content notifications', 'telegram-bot-trigger-notifications' ); ?></strong>
				<small><?php esc_html_e( 'Track publishing and editorial activity across selected post types.', 'telegram-bot-trigger-notifications' ); ?></small>
			</span>
		</label>

		<div class="myp-section">
			<div class="myp-section__title"><?php esc_html_e( 'Post types', 'telegram-bot-trigger-notifications' ); ?></div>
			<p class="myp-section__desc"><?php esc_html_e( 'All registered post types shown in the WordPress admin menu are detected automatically, including private types added by themes, plugins, and MU plugins.', 'telegram-bot-trigger-notifications' ); ?></p>
		...
		<div class="myp-section">
			<div class="myp-section__title"><?php esc_html_e( 'Content events', 'telegram-bot-trigger-notifications' ); ?></div>
	...
	<div class="myp-card myp-card--feature">
		<label class="myp-master">
			...
			<span class="myp-master__copy">
				<strong><?php esc_html_e( 'Media notifications', 'telegram-bot-trigger-notifications' ); ?></strong>
				<small><?php esc_html_e( 'Receive an alert whenever a new media file is uploaded.', 'telegram-bot-trigger-notifications' ); ?></small>
			</span>
		</label>
		<div class="myp-section">
	...
	<div class="myp-card myp-card--feature">
		<label class="myp-master">
			...
			<span class="myp-master__copy">
				<strong><?php esc_html_e( 'Comment notifications', 'telegram-bot-trigger-notifications' ); ?></strong>
				<small><?php esc_html_e( 'Follow moderation, spam, trash, and deletion events.', 'telegram-bot-trigger-notifications' ); ?></small>
			</span>
		</label>
		<div class="myp-section">
	...
	<div class="myp-card myp-card--feature">
		<label class="myp-master">
			...
			<span class="myp-master__copy">
				<strong><?php esc_html_e( 'Optional integrations', 'telegram-bot-trigger-notifications' ); ?></strong>
				<small>
					<?php
					echo 0 === $available_integration_count
						? esc_html__( 'No supported integration plugin is active. This section is safely disabled.', 'telegram-bot-trigger-notifications' )
						: esc_html__( 'Only detected, active commerce, forms, and page-builder plugins can be selected.', 'telegram-bot-trigger-notifications' );
					?>
				</small>
			</span>
		</label>
	...
	<div class="myp-action-bar">
		<div>
			<strong><?php esc_html_e( 'Apply trigger changes', 'telegram-bot-trigger-notifications' ); ?></strong>
			<span><?php esc_html_e( 'Only enabled groups and selected events will send messages.', 'telegram-bot-trigger-notifications' ); ?></span>
		</div>
		<button type="submit" class="button button-primary myp-button">
			<span class="dashicons dashicons-saved" aria-hidden="true"></span>
			<?php esc_html_e( 'Save triggers', 'telegram-bot-trigger-notifications' ); ?>
		</button>
	</div>
</form>
</div>
